...
UDP_SUBNET     = "192.168.0.0/24"      # Addresses that we accept BluRouter packets from.
...
syslog_pri     = syslog.LOG_NOTICE     # Syslog priority
syslog_facil   = syslog.LOG_USER       # Syslog facility

routesfile     = '/path/to/routes.txt' # Must be absolute path. Contains the routes to share
pidfile        = '/path/to/router.pid' # Must be absolute path.

endian         = 0 # Little endian (amd64 / x86)
#endian        = 1 # Big endian
